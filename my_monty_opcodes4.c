...
/**
 * my_monty_rotr - Rotates the bottom value of a stack_t
 * linked list to the top.
...
/**
 * my_monty_rotl - Rotates the top value of a stack_t
 * linked list to the bottom.
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 */
void my_monty_rotl(stack_t **stack, unsigned int line_number)
...
/**
 * my_monty_stack - queue to stack converter.
 * @stack: A pointer to the top mode node of a stack_t linked list.
...
/**
 * my_monty_queue - stack to  queue converter.
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: current working line number of a Monty bytecodes file.
 */
void my_monty_queue(stack_t **stack, unsigned int line_number)
